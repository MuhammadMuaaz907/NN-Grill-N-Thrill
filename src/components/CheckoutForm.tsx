        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="text-gray-600 mb-4">This is a delivery order 🚚</p>
              <p className="text-sm text-gray-500">Just a last step, please enter your details.</p>
            </div>
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-lg font-semibold mb-4">Personal Information</h2>
              <div className="grid grid-cols-2 gap-4 mb-4">
                <select {...register('title')} className="border rounded-lg p-2">
                  <option>Mr</option>
                  <option>Mrs</option>
                  <option>Ms</option>
                </select>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-lg font-semibold mb-4">Delivery Address <span className="text-red-500">*</span></h2>
              <textarea
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <input {...register('landmark')} placeholder="Nearest Landmark" className="border rounded-lg p-2" />
                <input {...register('email')} placeholder="Email Address" className="border rounded-lg p-2" />
              </div>
              <select {...register('area')} className="w-full border rounded-lg p-2 mb-4">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              {items.map((item: { name: string; quantity: number; price: number }, i: number) => (
                <div key={i} className="flex justify-between mb-2">
                  ...
                  <span className="text-pink-600 font-semibold">Rs. {item.price * item.quantity}</span>
                </div>
              ))}
            </div>
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="border-t pt-4">
                ...
                <button
                  ...
                  className="w-full bg-pink-600 hover:bg-pink-700 text-white font-bold py-3 rounded-lg mb-4"
                >
                  Place Order
                </button>
                <button
                  onClick={handleGoBack}
                  className="w-full text-blue-600 font-semibold py-2 rounded-lg mb-4"
                >
